...
public class ReportViewOverall extends JInternalFrame {
    ...
    public void search() {
        ReportData reportFiltered = new ReportData();
        ...
        try {
            while (reportFiltered.list.next()) {
                String strNameCustomer = reportFiltered.list.getString("name");
                String strValue = reportFiltered.list.getString("value");
                Date strDate = reportFiltered.list.getDate("date_shopping");
    ...
    public void searchInDatabase() {
        ...
        ReportData reportOverall = new ReportData();
        reportOverall.listPurchaseOverall();
        try {
            while (reportOverall.list.next()) {
                String strNameCustomer = reportOverall.list.getString("name");
                String strValue = reportOverall.list.getString("value");
                Date strDate = reportOverall.list.getDate("date_shopping");
                tableModel.addRow(new Object[]{strNameCustomer, DR.format(Double.parseDouble(strValue)), sdf.format(strDate)});
            }
        } catch (SQLException ex) {
            Logger.getLogger(ReportViewOverall.class.getName()).log(Level.SEVERE, null, ex);
